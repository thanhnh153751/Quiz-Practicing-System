...
public class ReSendMailUtil {
    ...
    public static Message htmlForm(Session session, String account, String to, String subject, String link) {
        final String content = "<!DOCTYPE html>\n"
                ...
                + "        <div class=\"content\">\n"
                + "            <h1>Online Quiz</h1>\n"
                + "            <p>Click here to reset password !\n"
...
//        send.sendHTMLEmail("dungnguyenkieu28@gmail.com", "Online Quiz - Confirm Account", "https://www.youtube.com/watch?v=37-70wUrEDs");
//
//    }
}
