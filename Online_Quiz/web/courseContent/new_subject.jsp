                                ...
                                <form class="d-flex" action="newsuject" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" class="input-text" type="text" name="title" placeholder="enter name,title of course">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="image-upload">
                                            ...
                                            <input class="form-control" id="file-input" type="file" name="file" onchange="loadFile(event)" />
                                    ...
                                    <div class="form-group">
                                        <label>Owner:</label>
                                        <input class="form-control" name="owner" class="input-text" type="text" placeholder="enter the name of the author or owner of the course">
                                    </div>
                                    <div class="form-group">
                                        <label>Status:</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" oninput="auto_grow(this)" style="width: 100%; min-height: 250px" name="paragraph_text" cols="50" rows="10" placeholder="Enter a description of the course,..."></textarea>
                                    </div>
                                    
                                    <div class="form-group">
                                            <input type="button" name="submit" id="edit" class="btn btn-success" value="Add new Course">
                                        </div>
                                </div>
